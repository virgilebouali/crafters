...
export const frequencies: PricingTierFrequency[] = [
  { id: '1', value: '1', label: 'Années', priceSuffix: '/an' },
  { id: '2', value: '2', label: 'Mois', priceSuffix: '/mois' },
];
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-center">
          <div className="w-full lg:w-auto mx-auto max-w-4xl lg:text-center">
            <h2 className="text-black dark:text-white text-4xl font-semibold max-w-xs sm:max-w-none md:text-6xl !leading-tight">
              Choissez l'offre pour développer <span className="border-b-2 border-violet-500"> votre projet</span>.
            </h2>
              ...
              >
                ...
                >
                  <Button
                    ...
                    className={cn(
                      'w-full text-purple-500 dark:text-white',
